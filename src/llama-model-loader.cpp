...
llama_model_loader::llama_model_loader(
    ...
    files.emplace_back(new llama_file(bytes, bytes_len));
   ...
   // Save tensors data offset of the main file.
    ...
    LLAMA_LOG_INFO("%s: loaded meta data with %d key-value pairs and %d tensors from bytes (version %s)\n",
    ...
    this->no_alloc = false;  // XX is that right?
}
